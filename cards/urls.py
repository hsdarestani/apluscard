...
urlpatterns = [
    ...
    path("accounts/verify/<str:token>/", email_verification_views.verify_email, name="verify_email"),
    path("accounts/verification-status/", verification_views.email_verification_status, name="email_verification_status"),
    path("accounts/resend-verification/", email_verification_views.resend_verification, name="resend_verification"),
    ...
    path("api/v1/me/", compliance_api.SecureMeView.as_view(), name="api_me"),
